...
public class Solution {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ivanov.join();
        while (ivanov.getSpeechCount() + petrov.getSpeechCount() + sidorov.getSpeechCount() < totalSpeechCount) { }  //нельзя чтоб все все сказали
    ...
    public static class Politician extends Thread {
        private volatile int utteranceCount;          // ВОЛТАИЛ
        ...
        public void run() {
            while (utteranceCount < totalSpeechCount * utterancesPerSpeech) {  // нельзя болтать вечно(скокоа хочешь
                utteranceCount++;
            }
        }
